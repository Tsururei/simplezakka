...
class OrderRepositoryTest {
    ...
    private Order createSampleOrder(String customerName) {
        ...
        order.setCustomerAddress("住所 " + customerName);
        ...
        order.setPayMethod("代引き");
        order.setStatus("PENDING"); // 初期ステータス

        OrderDetail detail1 = new OrderDetail();
        detail1.setProductId(product1.getProductId()); // 事前に永続化したProductエンティティを設定
        ...
        detail2.setProductId(product1.getProductId());

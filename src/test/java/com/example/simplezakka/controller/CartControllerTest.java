...
class CartControllerTest {
    ...
    private CartGuest cartWithOneItem;
    ...
    void setUp() {
        ...
        emptyCart = new CartGuest(); // items={}, totalQuantity=0, totalPrice=0
    ...
    class UpdateItemTests {
        ...
        void updateItem_WithValidData_ShouldReturnUpdatedCartWithStatusOk() throws Exception {
            ...
            CartGuest updatedCart = new CartGuest(); // 更新後のカート (ダミー)

...
class OrderControllerTest {
    ...
    private CartGuest cartWithItems;
    private CartGuest emptyCart;
    ...
    void setUp() {
        ...
        lenient().when(orderService.placeOrder(any(CartGuest.class), any(OrderRequest.class), any(HttpSession.class)))
    ...
    class PlaceOrderValidationErrorTests {
        ...
        void placeOrder_WithBlankAddress_ShouldReturnBadRequest() throws Exception {
            ...
            CustomerInfo invalidCustomer = new CustomerInfo();
            invalidCustomer.setCustomerName("Name");
            invalidCustomer.setCustomerAddress(""); // @NotBlank 違反
            invalidCustomer.setCustomerEmail("test@example.com");
            invalidCustomer.setShippingName("User"); 
            invalidCustomer.setShippingAddress("Addr");
            invalidCustomer.setPayMethod("代引き");            
    ...
    class PlaceOrderOtherErrorTests {
        ...
        void placeOrder_WhenOrderServiceThrowsRuntimeException_ShouldReturnInternalServerError() throws Exception {
            ...
            when(orderService.placeOrder(any(CartGuest.class), any(OrderRequest.class), any(HttpSession.class)))
